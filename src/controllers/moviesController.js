...
const moviesController = {
    ...
    update: function (req, res) {
        ...
        let { title, awards, rating, length, release_date, genre_id, actors } = req.body; //le cambie el "const" por "let" sino no me iba a dejar realizar lo que sigue
        actors = typeof actors === "string" ? [actors] : actors // si el typeof de actors es string me lo tiene que convertir en un array
